...
public class BombTest {
    ...
    public void placeDiagonallyAdjacentActiveSwitch() throws InvalidActionException {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_bombTest_placeDiagonallyActive",
             "c_bombTest_placeDiagonallyActive");
    ...
    public void placeCardinallyActive() throws InvalidActionException {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_bombTest_placeCardinallyActive",
    ...
    public void placeCardinallyActivated() throws InvalidActionException {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_bombTest_placeCardinallyActivated",
    ...
    @Test
    @Tag("8-6")
    @DisplayName("Test placing a bomb cardinally adjacent to an"
                + "inactive switch does not cause the bomb to explode")
    public void placeCardinallyInactive() throws InvalidActionException {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_bombTest_placeCardinallyInactive",
            "c_bombTest_placeCardinallyInactive");
    ...
    @DisplayName("Test surrounding entities are removed when placing a"
        + "bomb next to an active switch with bomb radius set to 2")
    ...
    public void placeBombRadius10() throws InvalidActionException {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_bombTest_placeBombRadius10",
            "c_bombTest_placeBombRadius10");
