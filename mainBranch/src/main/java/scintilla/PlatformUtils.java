...
final class PlatformUtils {
    ...
    public static final boolean openBrowserAtPath(String path) {
        // A way you could approach this is java.awt but that typically requires as many
        // steps as this
        // and is pretty deprecated these days, this is just simpler and will be more
        // crossplatform

        // Since students can call this directly we need to ensure we aren't running in
        // headless
        ...
        switch (determineOperatingSystem()) {
            ...
            default:
            case Linux:
                // if it's an unknown file system we'll just open it as linux since it's most
                // likely something like Solaris
                command = "xdg-open";
                break;
        }
